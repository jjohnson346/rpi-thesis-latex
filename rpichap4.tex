...
\centering
\vspace{1.0in}
\framebox{\includegraphics[width=140mm]{cfe_manual_toc.png}}
...
\centering
\vspace{1.0in}
\framebox{\includegraphics[width=0.9\textwidth]{document_collection.png}}
...
\centering
\vspace{1.0in}
\framebox{\includegraphics[width=0.9\textwidth, height=125mm]{concept_match_v1_example.png}}
...
\begin{tabular}{| l r |}
		\hline
		\textbf{Concept Match V2 vs. Max Frequency}  & \\
		 & \\
		H\textsubscript{0}:  Agent answer rate = 0.48 & \\
		H\textsubscript{1}:  Agent answer rate $>$ 0.48 & \\
		 &  \\
		Question Count & 150 \\
...
\begin{tabular}{| l r |}
		\hline
		\textbf{Concept Match V3 vs. Concept Match V2}  & \\
		 & \\
		H\textsubscript{0}:  Agent answer rate = 0.673 & \\
		H\textsubscript{1}:  Agent answer rate $>$ 0.673 & \\
		 &  \\
		Question Count & 150 \\
		...
		z-score for p-value of 1\% & 2.325 \\
		 & \\
		Conclusion: & Accept H\textsubscript{0}. \\
		\hline
\end{tabular}
}
...
\centering
\vspace{0.75in}
\framebox{\includegraphics[width=90mm, height=125mm]{concept_match_not_example_part_1.png}}
...
\begin{table}[h!]
\centering
\caption{Concept Match Not vs. Random Guessing Hypothesis Test on Definition/Not Questions}
\small
\resizebox{0.6\textwidth}{!}{
\begin{tabular}{| l r |}
		\hline
		\textbf{Concept Match Not vs. Random Guessing}  & \\
		 & \\
		...
		z-score for Observed Exam Score & 0.5555556 \\
		z-score for p-value of 1\% & 2.325 \\
		 & \\
		Conclusion: & Accept H\textsubscript{0}. \\
		\hline
...
\label{table:concept_match_not_hypothesis_test}
\end{table}
...
\begin{tabular}{| l r |}
		\hline
		\textbf{Concept Match NOTA vs. Max Frequency}  & \\
		 & \\
		H\textsubscript{0}:  Agent answer rate = 0.565 & \\
		H\textsubscript{1}:  Agent answer rate $>$ 0.565 & \\
		 &  \\
		Question Count & 161 \\
...
\centering
\vspace{0.25in}
\framebox{\includegraphics[width=200mm, height=80mm]{version_2_training_set_performance.png}}
...
\begin{tabular}{| l r |}
		\hline
		\textbf{CFE Agent Version 2 vs. CFE Agent Version 1}  & \\
		\textbf{Multiple Choice Questions} & \\
		 & \\
		H\textsubscript{0}:  Agent answer rate = 0.497 & \\
		H\textsubscript{1}:  Agent answer rate $>$ 0.497 & \\
		 &  \\
		Question Count & 867 \\
...
\label{table:version_2_multiple_choice_hypothesis_test}
\end{table}

Running the CFE Agent on the test set of 200 questions yields a score of 119 out of 200, or 59.5\%, a dramatic improvement over the 49.7\% of Version 1.  This shows that the more sophisticated algorithms in Version 2 offer significantly better performance, on the order of 10\% marginal benefit in terms of accuracy, and offer some degree of argument-based justification.
